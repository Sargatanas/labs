...
echo '<div style="margin: 20px 0;">8. Дан файл. В первой строке хранится имя первого пользователя, во второй – фамилия, в третьей – возраст, в четвертой – имя второго пользователя, в пятой – его фамилия и т.д.<br>Сформировать ассоциативный массив из элементов файла.</div>';
